...
const users = [
  {id : 1, email: "admin@admin.com",password:"admin1234", fname: "Ashish", lname: "Sharma", married: "No",role : "admin" },
  {id : 2, email: "user@user.com",password:"user1234", fname: "Anurag", lname: "Sharma", married: "Yes",role : "user" },
];

const carts = [];
const wishlist = [];

module.exports = { mobiles, pincodes, reviews, users,carts,wishlist };
